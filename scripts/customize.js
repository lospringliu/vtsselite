...
const customize = {
  './src/gun-vue/composables/user/usePass.ts': {
    replaces: [
  ...
  './src/gun-vue/components/space/SpaceDraw.vue': {
    replaces: [
  ...
  './src/gun-vue/components/chat/ChatMessages.vue': {
    replaces: [
  ...
  './src/gun-vue/components/post/PostList.vue': {
    replaces: [
  ...
  './src/gun-vue/components/post/PostForm.vue': {
    replaces: [
  ...
  './src/gun-vue/components/user/UserAvatar.vue': {
    replaces: [
  ...
  './src/gun-vue/components/user/UserAuth.vue': {
    replaces: [
  ...
  // ]},
  './src/gun-vue/composables/user/useUser.ts': {
    replaces: [
  ...
  './src/gun-vue/components/ui/Uilayer.vue': {
    replaces: [
      ['10vh', '5vh'],
    ],
  },
  ...
  //   [`chat-private-list\\(@chat`, `chat-private-list(:title="t('customize.chat_title')" @chat`],
  // ]},
  './src/gun-vue/components/styles/index.css': {
    replaces: [
      ['10px', '0'],
    ],
  },
